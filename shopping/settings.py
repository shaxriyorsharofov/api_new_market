...
SECRET_KEY = os.environ.get('SECRET_KEY', 'g_h_=gr(m6z6si=q%$9v4p59#qi@_!^%vw3$i+d#gk*uhdzy=a')
...
EMAIL_HOST_USER = os.environ.get('SMTP_HOST_USER', 'umarket.noreply@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('SMTP_HOST_PASSWORD', '$umarket12$')
EMAIL_PORT = 587
